...
import (
	...
	"ied_reporter_api/internal/features/supervision/data"
	"ied_reporter_api/internal/features/supervision/domain"
)

// Supervisor spawns and monitors a single ied_reporter_daemon process.
