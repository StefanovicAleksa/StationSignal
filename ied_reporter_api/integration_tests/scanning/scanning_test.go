...
// Package scanning_test drives the full scanning lifecycle against a real ied_reporter_daemon
// binary and a real ied_reporter_api process — nothing mocked. Scanning doesn't need a raw
...
import (
	...
	"ied_reporter_api/integration_tests/testutil"
)
