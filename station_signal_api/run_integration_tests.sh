...
# against the REAL station_signal_daemon binary and, for reporting, the daemon's own manual IED
# simulator — nothing mocked, mirroring station_signal_daemon/run_all_tests.sh's own approach.
#
