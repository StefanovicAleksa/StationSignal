# station_signal_api — Overview

The Go service between the frontend and `station_signal_daemon` (see `../CLAUDE.md` and the
...
`cmd/station_signal_api/main.go` is wiring only, no business logic:
