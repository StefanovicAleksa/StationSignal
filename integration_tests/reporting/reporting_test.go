...
// Package reporting_test drives device reporting against a real ied_reporter_daemon binary
// and a real ied_reporter_api process — nothing mocked. Unlike scanning, START_REPORTING
