...
`/tmp/ied_reporter_debug_model_build.log` (`IED_MODEL_ONLINE_LOADER_DEBUG_LOG_PATH`).
...
- The debug log (`appendDebugLog` → `/tmp/ied_reporter_debug_model_build.log`)
  ...
  `ied_reporter_debug_entryid.log` — not a permanent logging feature.
