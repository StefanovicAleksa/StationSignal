# station_signal_daemon — API Guide for Agents

This is a self-contained reference for integrating against a running `station_signal_daemon`
...
The daemon is a single process, `station_signal_daemon`, built from this repo (see the repo's
