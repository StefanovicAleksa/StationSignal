...
// reporting device's sclFilePath. This API and the ied_reporter_daemon it supervises always run
// on the same box (see ied_reporter_api/CLAUDE.md's single-box deployment model), so a path
